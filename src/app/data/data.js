...
//     {
//         icon:FiShoppingCart,
//         link:'https://1.envato.market/Cufino-next'
//     },
//     {
//         icon:FiDribbble,
...
export const clientData = [
    {
        ...
        name:'Christa Smith',
        possition:'Manager',
        desc:'" Cufino made the processes so easy. Cufino instantly increased the amount of interest and ultimately saved us over $10,000. "'
    },
    {
        image:'/images/client/02.jpg',
        name:'Christa Smith',
        possition:'Manager',
        desc:'" I highly recommend Cufino as the new way to sell your home "by owner". My home sold in 24 hours for the asking price. Best $400 you could spend to sell your home. "'
    },
    {
    ...
    },
    {
        ...
        name:'Christa Smith',
        possition:'Manager',
        desc:'" Cufino made selling my home easy and stress free. They went above and beyond what is expected.. "'
    },
    {
        image:'/images/client/06.jpg',
        name:'Christa Smith',
        possition:'Manager',
        desc:'" Cufino is fair priced, quick to respond, and easy to use. I highly recommend their services! "'
    },
]
...
export const brand = [
    ...
    },
    {
        id:3,
        name:[
            'Cherokee','Chiara Ferragni','Daniele Alessandrini','Daniele Fiesoli','Demdaco','Department Five','Design Toscano','Designq','Desigual','Dolce Vita','Dondup','Dorothee Schumacher','Doucals','Dr. Martens','Logitech','Cufino',
        ]
    },
]
...
export const guidenceData = [
    ...
    {
        name:'Your listings',
        features:['Updating your listing','Neighbourhoods','Listing photos & photography','Cufino Plus','API-connected software']
    },
    {
    ...
    },
    {
        ...
        features:['Cufino safely','Cufino Experiences and Adventures','Changing a reservation','Cancelling a reservation','Long-term reservations']
    },
    {
...
export const faqData = [
    ...
    {
        id:2,
        title:'Do I need a designer to use Cufino ?',
        desc:'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.'
    },
    {
        id:3,
